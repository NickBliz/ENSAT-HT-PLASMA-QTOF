...
captain2=pearl[,-which(colSums(is.na(pearl[which(jack$RUN=="run1"),]))>=22 | colSums(is.na(pearl[which(jack$RUN=="run2"),]))>=22 | colSums(is.na(pearl[which(jack$RUN=="run3"),]))>=24 | colSums(is.na(pearl[which(jack$RUN=="run4"),]))>=24 | colSums(is.na(pearl[which(jack$RUN=="run5"),]))>=24 | colSums(is.na(pearl[which(jack$RUN=="run6"),]))>=22)]
...
test2=test[,-which(colSums(is.na(pearl[which(jack$RUN=="run1"),]))>=22 | colSums(is.na(pearl[which(jack$RUN=="run2"),]))>=22 | colSums(is.na(pearl[which(jack$RUN=="run3"),]))>=24 | colSums(is.na(pearl[which(jack$RUN=="run4"),]))>=24 | colSums(is.na(pearl[which(jack$RUN=="run5"),]))>=24 | colSums(is.na(pearl[which(jack$RUN=="run6"),]))>=22)]
