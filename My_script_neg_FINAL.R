...
plotIndiv(pca.EQP, group = EQP_METADATA_NEG$GROUP, title = "NEG QTOF", ind.names = F,legend = T,cex=4)
...
pca.EQP = pca(X, ncomp = 10, center = TRUE, scale = FALSE)
plotIndiv(pca.EQP, group = EQP_METADATA_NEG$GROUP[-which(EQP_METADATA_NEG$GROUP=="X" | EQP_METADATA_NEG$GROUP=="Qc Nick" | EQP_METADATA_NEG$GROUP=="QC plasmamonster" | EQP_METADATA_NEG$GROUP=="HV")], title = "NEG QTOF", ind.names = F,legend = T,cex=4)
plotIndiv(pca.EQP, group = EQP_METADATA_NEG$`CENTER ID`[-which(EQP_METADATA_NEG$GROUP=="X" | EQP_METADATA_NEG$GROUP=="Qc Nick" | EQP_METADATA_NEG$GROUP=="QC plasmamonster" | EQP_METADATA_NEG$GROUP=="HV")], title = "NEG QTOF", ind.names = F,legend = T,cex=4)
X1=X
