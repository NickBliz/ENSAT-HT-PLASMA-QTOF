...
AHTVPHT2=list(allconf, all.BER, all.AHT, all.PHT)
...
AHTVPHT3=list(cvfit1, rich)
AHTVPHT4=list(allconf, all.BER, all.AHT, all.PHT)
...
AHTVPHT5=list(plsda.select, splsda.select, perf.plsda.select, tune.splsda.select, rich)
AHTVPHT6=list(allconf, all.BER, all.AHT, all.PHT)
...
AHTVPHT7=list(cvfit1, rich)
AHTVPHT8=list(allconf, all.BER, all.AHT, all.PHT)

#APPROACH C
X=EQP_NEG
row.names(X)=EQP_METADATA_NEG$`sample name 2`
X=X[-which(EQP_METADATA_NEG$GROUP=="X" | EQP_METADATA_NEG$GROUP=="Qc Nick" | EQP_METADATA_NEG$GROUP=="QC plasmamonster" | EQP_METADATA_NEG$GROUP=="HV" | EQP_METADATA_NEG$`CENTER ID`=="GBGL2" | (EQP_METADATA_NEG$`CENTER ID`=="FRPA1" & EQP_METADATA_NEG$GROUP=="PHT")),]
WHYF=data.frame(EQP_METADATA_NEG[-which(EQP_METADATA_NEG$GROUP=="X" | EQP_METADATA_NEG$GROUP=="Qc Nick" | EQP_METADATA_NEG$GROUP=="QC plasmamonster" | EQP_METADATA_NEG$GROUP=="HV"| EQP_METADATA_NEG$`CENTER ID`=="GBGL2" | (EQP_METADATA_NEG$`CENTER ID`=="FRPA1" & EQP_METADATA_NEG$GROUP=="PHT")),])

pca.EQP = pca(X, ncomp = 10, center = TRUE, scale = FALSE)
plotIndiv(pca.EQP, group = WHYF$CENTER.ID, title = "NEG QTOF", ind.names = T,legend = T,style = "3d")
plotIndiv(pca.EQP, group = WHYF$CENTER.ID, title = "NEG QTOF", ind.names = T,legend = T,style = "3d",cex=4, pch = "sphere" )
plotIndiv(pca.EQP, group = WHYF$CENTER.ID, title = "NEG QTOF", ind.names = T,legend = T,style = "3d",cex=4, pch = "sphere", comp = c(4,5,6) )
plotIndiv(pca.EQP, group = WHYF$CENTER.ID, title = "NEG QTOF", ind.names = T,legend = T,style = "3d",comp = c(4,5,6) )
plotIndiv(pca.EQP, group = WHYF$GROUP, title = "NEG QTOF", ind.names = T,legend = T,style = "3d")
plotIndiv(pca.EQP, group = WHYF$GROUP, title = "NEG QTOF", ind.names = T,legend = T,style = "3d",cex=4, pch = "sphere")
plotIndiv(pca.EQP, group = WHYF$GROUP, title = "NEG QTOF", ind.names = T,legend = T,style = "3d",cex=4, pch = "sphere",comp = c(4,5,6))
