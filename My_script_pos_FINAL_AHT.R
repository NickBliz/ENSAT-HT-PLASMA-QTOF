...
row.names(EQP_POS)==EQP_METADATA_POS$X1

library(mixOmics)
X=EQP_POS
row.names(X)=EQP_METADATA_POS$`sample name 2`
pca.EQP = pca(X, ncomp = 10, center = TRUE, scale = FALSE)
#tune.pca(X, ncomp = 10, center = TRUE, scale = FALSE)
plotIndiv(pca.EQP, group = EQP_METADATA_POS$GROUP, title = "POS QTOF", ind.names = F,legend = T,cex=4, pch = "sphere", style = "3d")
...
pca.EQP = pca(X, ncomp = 10, center = TRUE, scale = FALSE)
plotIndiv(pca.EQP, group = EQP_METADATA_POS$GROUP[-which(EQP_METADATA_POS$GROUP=="X" | EQP_METADATA_POS$GROUP=="Qc Nick" | EQP_METADATA_POS$GROUP=="QC plasmamonster" | EQP_METADATA_POS$GROUP=="HV")], title = "POS QTOF", ind.names = F,legend = T,cex=4, pch = "sphere", style = "3d")
plotIndiv(pca.EQP, group = EQP_METADATA_POS$`CENTER ID`[-which(EQP_METADATA_POS$GROUP=="X" | EQP_METADATA_POS$GROUP=="Qc Nick" | EQP_METADATA_POS$GROUP=="QC plasmamonster" | EQP_METADATA_POS$GROUP=="HV")], title = "POS QTOF", ind.names = F,legend = T,cex=4, pch = "sphere", style = "3d")

WHYF=data.frame(EQP_METADATA_POS[-which(EQP_METADATA_POS$GROUP=="X" | EQP_METADATA_POS$GROUP=="Qc Nick" | EQP_METADATA_POS$GROUP=="QC plasmamonster" | EQP_METADATA_POS$GROUP=="HV"),])
